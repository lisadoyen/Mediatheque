    ...
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
                    ...
                    .')'
                .')'
                .'|/adherent/bibliotheque/show(?:/(.+))?(*:206)'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        206 => [
            [['_route' => 'adherent_bibliotheque_show_genre', 'genre' => null, '_controller' => 'App\\Controller\\Adherent\\MediathequeControllerAdherent::showBibliothequeByType'], ['genre'], ['GET' => 0], null, false, true, null],
