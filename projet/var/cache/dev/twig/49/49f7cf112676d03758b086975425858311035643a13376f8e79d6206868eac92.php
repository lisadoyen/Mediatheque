...
class __TwigTemplate_6c1fda545c5e3840bd458ea46fda5f3ecfe8d0b6a28496bd8dcddf5c467e6299 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["genre"]) {
            ...
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["genre"], "libelle", [], "any", false, false, false, 14), "html", null, true);
            echo "</div>
    ...
    <div class=\"low-container\">
        ...
        <div class=\"row\">
            {% for genre in genres %}
                <div class=\"col-md-3\">
                    <div class=\"card bg-light mb-3\">
                        <div class=\"card-header\">{{ genre.libelle }}</div>
                        <div class=\"card-body center\">
...
{% endblock %}
", "genres/show_genres_livres.html.twig", "/home/thibault/Documents/S3/Mediatheque/projet/templates/genres/show_genres_livres.html.twig");
    }
}
